        ...
        report.update(
            {
                ...
                "june_shopee_gmv_total": summary.get("june_shopee_gmv_total"),
                "may_tiktok_gmv_total": summary.get("may_tiktok_gmv_total"),
                "june_tiktok_gmv_total": summary.get("june_tiktok_gmv_total"),
                "tiktok_may_gmv_fetched_count": summary.get("tiktok_may_gmv_fetched_count"),
                "tiktok_june_gmv_fetched_count": summary.get("tiktok_june_gmv_fetched_count"),
