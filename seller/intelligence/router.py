...
async def intelligence_v1_business():
    ...
    return {
        ...
        "summary": {
            ...
            "normal_count": sum(1 for s in sellers if s.get("platform_source") == "NORMAL"),
            "shopee_only_count": sum(1 for s in sellers if s.get("platform_source") == "SHOPEE_ONLY"),
            "tiktok_only_count": sum(1 for s in sellers if s.get("platform_source") == "TIKTOK_ONLY"),
        },
        "sellers": sellers,
